            ...
            <div class="col-md-12">
                <div class="login-box">
                    ...
                    <div class="login-form">
                        <form id="form-login" action="{{ route('register') }}" class="form-horizontal ls_form" method="POST">
                                        @csrf
                            ...
                            <div class="input-group ls-group-input">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                 name="email" value="{{ old('email') }}" required autocomplete="login" autofocus>
                            ...
                            @enderror
                            <div class="input-group ls-group-input">
                                <input id="" type="text" class="form-control @error('phone') is-invalid @enderror"
                                 name="phone" value="{{ old('phone') }}"  autocomplete="login" autofocus>
